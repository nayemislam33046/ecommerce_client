              ...
              >
                <div className="flex items-center justify-between gap-10 w-[500px] bg-gray-300 p-2 rounded">
                  <img
                    src={cart.images[0]}
                    alt={cart.name}
                    className="w-16 h-16 md:w-20 rounded-full "
                  />
                  <div>
                  ...
                  <div className="flex items-center">
                    <button
                      className="w-5 border disabled:bg-gray-600 disabled:text-white"
                      onClick={() =>
                        dispatch({
                          type: "DECREMENT",
                          payload: { id: cart.id, qty: cart.qty - 1 },
                        })
                      }
                    ...
                    <button
                      ...
                      disabled={cart.qty >= 5 ? true : false}
                    >
                      +
                    </button>
                  </div>
